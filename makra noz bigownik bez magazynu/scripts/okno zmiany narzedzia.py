...
T1 = Button(window, text='Wrzeciono', font= ("Times New Roman",14), command = T1_Change, bg = "green" )		
T1.place(x=40, y=30, height=40, width=110)		

T2 = Button(window, text='Nóż ', font= ("Times New Roman",14), command =T2_Change, bg = "green" )		
T2.place(x=40, y=80, height=40, width=110)	

T3 = Button(window, text='Bigownik ', font= ("Times New Roman",14), command =T3_Change, bg = "green" )		
