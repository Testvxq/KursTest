...
T5 = Button(window, text='Narzêdzie T5', font= ("Times New Roman",14), command = T5_Change, bg = "green" )		
T5.place(x=40, y=230, height=40, width=110)		

T6 = Button(window, text='Narzêdzie T6 ', font= ("Times New Roman",14), command = T6_Change, bg = "green" )		
T6.place(x=40, y=280, height=40, width=110)	

T7 = Button(window, text='Narzêdzie T7', font= ("Times New Roman",14), command = T7_Change, bg = "green" )		
T7.place(x=40, y=330, height=40, width=110)	

T8 = Button(window, text='Narzêdzie T8', font= ("Times New Roman",14), command = T8_Change, bg = "green" )		
T8.place(x=40, y=380, height=40, width=110)	

EXIT = Button(window, text='WYJŒCIE ', font= ("Times New Roman",14), command = EXIT, bg = "grey" )		
