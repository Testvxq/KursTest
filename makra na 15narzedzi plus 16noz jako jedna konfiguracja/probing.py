...
probeStartAbsPos = [232.23,3197.74, -10]   #pozycja czujnika wskazana wrzecionem1!
Spindle2Offset=[-225.6,75]											#noza od wrzeciona[X,Y]
OscilationOffset= 16.1											#ofset oscylacji noza (noz przy pomiarze wci�niett do gory
...
if(moveY == True):
	pos[Axis.Y.value] = probeStartAbsPos[Axis.Y.value]-200
	d.moveToPosition(CoordMode.Machine, pos, vel)
