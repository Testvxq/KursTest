...
OutSpindle1=2					#Wyjscie noza
OutSpindle2=3				#Wyjscie bigownika
...
if (NewTool==ActTool):
	if (NewTool==2 and IsOutSpindle1Active()):
			d.setTangentialAxisEnable(True)
			print ("narzedzie 2 aktualnie zaladowane")
	elif (NewTool==3 and IsOutSpindle2Active() and IsOutSpindle1Active()):
			d.setTangentialAxisEnable(True)
