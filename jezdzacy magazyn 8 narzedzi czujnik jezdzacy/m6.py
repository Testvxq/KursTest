...
InSpindleRotation="10"			#wejscie obrot�w wrzeciona
#outputs
OutMagazyn="4"					#wyjscie wyjazdu magazynu
...
EscapeSpeed="F20000"		#predkosc wyjazdu z magazynu

#tool position [X,Y,Z]
T1=[312.9,2463.6,-90.2816]						#pzycje narz�dzi kolejno po przecinkach x,y,z			
T2=[464.22,2463.7,-90.2816]
T3=[614.1,2466,-90.2816]
T4=[763.2,2467.3,-90.2816]
T5=[915.1,2467.9,-90.2816]
T6=[1065.40,2468.4,-90.2816]
T7=[1214.90,2471.3,-90.2816]
T8=[1366.71,2473.5,-90.2816]
#END CONFIG BLOCK
#############################################
...
def DustCoverUp():
	...
	mod_IP.setDigitalIO(OutMagazyn,DIOPinVal.PinSet)                             
def DustCoverDown():
	mod_IP.setDigitalIO(OutDustCover,DIOPinVal.PinReset)   
	mod_IP.setDigitalIO(OutMagazyn,DIOPinVal.PinReset)                         
def CleanConeOn():
