...
probeStartAbsPos = [123.663,3365.893, -100]
...
aggregateheigh=0                              // jeżeli nie ma agregatu 0!!!
#############################################
###### END SETTINGS
#############################################
...
if(toolNr==18):
	toolOffset=toolOffset-aggregateheigh
...
if(moveY == True):
	pos[Axis.Y.value] = probeStartAbsPos[Axis.Y.value]-300
	d.moveToPosition(CoordMode.Machine, pos, vel)
