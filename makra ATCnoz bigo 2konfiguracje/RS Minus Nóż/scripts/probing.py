...
probeStartAbsPos = [123.704,3250.500,-100]#pozycja czujnika wskazana wrzecionem!
Spindle2Offset=[-105.200,0.6]									#ofset noza [X,Y]
...
if(toolNr==1):
	probeStartAbsPos[0]=probeStartAbsPos[0]
	probeStartAbsPos[1]=probeStartAbsPos[1]
if(toolNr==2):
...
if toolNr==1:
	mod_IP.setDigitalIO(4, DIOPinVal.PinSet)
if toolNr==2:
	mod_IP.setDigitalIO(5, DIOPinVal.PinSet)
	mod_IP.setDigitalIO(4, DIOPinVal.PinSet)
